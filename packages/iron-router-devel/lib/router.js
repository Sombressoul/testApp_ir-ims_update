...
/**
 * Find route with given index for the given url and options.
 */
Router.prototype.findRoute = function (url, routeMatchIndex) {
  ...
  if (matches.length > routeMatchIndex) {
    return matches[routeMatchIndex];
  }
 ...
 *  This method is used to save backward compatibility.
 */
 ...
 */
Router.prototype.createController = function (url, context, routeMatchIndex) {
  var routeMatchIndex = routeMatchIndex || 0;
